    ...
    <div className="flex h-screen p-8 bg-green-500 gap-5 items-center justify-center">
      <div className="bg-white w-5/12 p-6 rounded-md">
        <div className="flex flex-1 flex-col h-full items-center justify-center gap-8">
            ...
            <InputComponent label="Login" id="login" name="login" onChange={(e: { target: { value: SetStateAction<string>; }; }) => setLogin(e.target.value)} values={login} />
            <InputComponent label="Senha" id="password" name="password" onChange={(e: { target: { value: SetStateAction<string>; }; }) => setPassword(e.target.value)} values={password} />
